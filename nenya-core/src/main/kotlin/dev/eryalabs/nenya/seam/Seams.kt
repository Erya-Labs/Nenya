 ...
 * sweeps `src/main/kotlin` for exactly that token, among others, and a distinct name keeps the
 ...
 * `java.util.Random`.
 *
 * The suite sweeps `src/main/kotlin` for ambient randomness, so no code in this library can
