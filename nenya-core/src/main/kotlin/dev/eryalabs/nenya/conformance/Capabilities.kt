 ...
 *   stale reading here;
 * - [evidenceClasses] must be found by reflection in `build/classes/kotlin/main`, so an item
...
public class ConformanceItem internal constructor(
    ...
    /**
     * Fully-qualified names of classes in `src/main` that do this item's work, or empty when
